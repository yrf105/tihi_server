...
const std::string Logger::toYAMLString() const {
    YAML::Node node;
    node["name"] = name_;
...
const std::string FileLogAppender::toYAMLString() const {
    YAML::Node node;
...
const std::string StdOutLogAppender::toYAMLString() const {
    YAML::Node node;
...
const std::string LoggerManager::toYAMLString() const {
    YAML::Node node;
    for (auto& l : loggers_) {
        if (!l.second) {
            continue ;
